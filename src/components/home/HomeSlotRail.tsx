...
export function HomeSlotRail({ side, slots, activeSlot, recommendedSlot, onToggleSlot }: HomeSlotRailProps) {
  return (
    <section
      ...
      className="rounded-[30px] border border-border/70 bg-card/68 p-3 shadow-[0_22px_70px_-48px_rgba(15,23,42,0.72)] backdrop-blur-xl"
    >
        ...
        {slots.map((slot) => {
          ...
          return (
            <button
              ...
              className={cn(
                "group grid min-h-[98px] gap-3 rounded-[24px] border px-4 py-4 text-left transition-all focus-visible:outline-none focus-visible:ring-[3px] focus-visible:ring-ring/60 disabled:cursor-not-allowed disabled:opacity-45 xl:min-h-[136px] xl:px-3 xl:py-5",
            ...
            >
              <div className="flex items-start justify-between gap-3 xl:flex-col xl:items-center xl:text-center">
                <div
                  className={cn(
                ...
                <div className="flex flex-wrap items-center gap-2 xl:justify-center">
                  <span className="text-sm font-semibold tracking-[0.01em]">{slot.label}</span>
                  {slot.badge ? (
              ...
              <p className="line-clamp-2 text-sm leading-6 text-muted-foreground xl:text-center">{slot.description}</p>
