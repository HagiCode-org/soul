...
export function SourceFootnote({ sourceNotes, generatedAtUtc }: SourceFootnoteProps) {
  return (
    <Card id="sources">
      <CardHeader className="gap-3 border-b border-border/60 pb-5">
        <Badge variant="secondary">来源说明</Badge>
        <CardTitle className="font-display text-3xl tracking-[-0.04em]">输入边界。副作用来源。都写清。</CardTitle>
      </CardHeader>
      <CardContent className="grid gap-4 py-6 lg:grid-cols-[minmax(0,1.2fr)_minmax(0,0.8fr)]">
